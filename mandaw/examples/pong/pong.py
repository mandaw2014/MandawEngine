...
mandaw.window.onkey(paddle_a.paddle_up, "w")
mandaw.window.onkey(paddle_a.paddle_down, "s")

mandaw.window.onkey(paddle_b.paddle_up, "Up")
mandaw.window.onkey(paddle_b.paddle_down, "Down")
